...
<div
    class="kanban-scroll flex-1 overflow-x-auto overflow-y-hidden bg-[#f0f2f5] dark:bg-[#0d141c] p-4 pl-4 md:py-8 md:pr-8 md:pl-10 md:ml-2 custom-scrollbar rounded-tl-none md:rounded-tl-2xl"
>
