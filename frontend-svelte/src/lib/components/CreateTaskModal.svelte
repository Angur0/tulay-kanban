<script lang="ts">
    ...
    import { createTaskColumnId, setCreateTaskColumnId } from "$lib/stores/board";
    ...
    function handleCreate() {
        ...
        if (!trimmed || !$createTaskColumnId) return;
            ...
            >
                <div class="p-6">
                    <div class="flex items-center gap-3 mb-4 text-primary">
                        ...
                        <h3 class="text-lg font-bold text-[#111418] dark:text-white">Create Task</h3>
                    </div>
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button
                            ...
                            disabled={!title.trim() || !$createTaskColumnId}
                        >
                            Create Task
                        </button>
                    </div>
