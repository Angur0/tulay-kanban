...
export const getWsUrl = (boardId) => `${wsProtocol}://${window.location.host}/ws/${boardId}`;

export const BOARD_ICONS = new Set([
    'dashboard',
    'folder',
    'campaign',
    'code',
...
export function normalizeBoardIcon(icon) {
    return BOARD_ICONS.has(icon) ? icon : 'dashboard';
}

export const columnColorClasses = [
    'bg-amber-500',
    'bg-primary',
    'bg-green-500',
    'bg-purple-500',
